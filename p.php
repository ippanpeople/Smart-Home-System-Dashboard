...
<div class="app">
 <div class="header">
  ...
  <div class="header-menu">
   <a class="menu-link is-active" href="#">Smart Home</a>
  </div>
 ...
 <div class="wrapper">
  ...
  <div class="main-container">
   <div class="main-header">
    <div class="header-menu">
     <a class="main-header-link is-active" href="#">Dashboard</a>
     <a class="main-header-link" href="#">Auto Control</a>
     <a class="main-header-link" href="#">Security</a>
   ...
   <div class="content-wrapper">
    <div class="content-section">
     ...
     <ul>
      ...
      <li class="adobe-product">
       ...
       <span class="status">
        <span class="status-circle"></span>Power Down</span>
       <div class="button-wrapper">
        <button class="content-button status-button">Restart Service</button>
        <div class="pop-up">
      ...
      <li class="adobe-product">
       ...
       <div class="button-wrapper">
        <button class="content-button status-button open">Add Room</button>
        <div class="menu">
         <button class="dropdown">
          <ul>
           <li><a href="#">Go to Discover</a></li>
    ...
    <div class="content-section">
     <div class="content-section-title">Controllers</div>
     <div class="apps-card">
      <div class="app-card">
       <span>
        Controller 1
       </span>
       <div class="app-card__subtext">エアコン</div>
       <div class="app-card-buttons">
        <button class="content-button status-button">Setting</button>
        <div class="menu"></div>
       </div>
      </div>
      <div class="app-card">
       ...
       <div class="app-card__subtext">電気</div>
       <div class="app-card-buttons">
        <button class="content-button status-button">Setting</button>
        <div class="menu"></div>
       </div>
      ...
      <div class="app-card">
       ...
       <div class="app-card__subtext">TV</div>
       <div class="app-card-buttons">
        <button class="content-button status-button">Setting</button>
        <div class="menu"></div>
       </div>
